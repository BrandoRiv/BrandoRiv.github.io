export default {
    ...
    about: "Deeply connected to Columbus, I’m a software developer eager to work with local businesses and provide tech-driven solutions to help them grow. I aim to leverage my skills to support organizations in the Greater Columbus area. With a strong background in both front-end and back-end development, I'm excited to collaborate and deliver innovative services that help my community thrive.",
    
    skills: {
      languages: ["C#", "Java", "JavaScript", "SQL", "HTML", "CSS", "Python", "C", "R", "Prolog", "Scheme"],
      frameworks: ["React", "ASP.NET", "Entity Framework", "Blazor", "Node.js", "Bootstrap", "AngularJS", "Springboot"],
